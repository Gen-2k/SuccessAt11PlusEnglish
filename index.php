...
<head>
    ...
    <meta name="description"
        content="SuccessAt11PlusEnglish provides expert online tutoring for 11+ exams. We cover all boards including Kent 11 plus, independent schools, entrance exams and SATs." />
...
<body id="main">    <!-- Newsletter Popup -->
    ...
    <main>
                    ...
                    <div class="col-lg-7 position-relative" style="z-index: 1;">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    <p class="mb-0 fs-4 text-dark">We offer <strong class="blue">tailored</strong>, <strong
                    ...
                    <div class="col-lg-5 text-center text-lg-end position-relative" style="z-index: 1;">
                        <div class="position-relative">
                            <img src="./assets/images/success/herosection-image.png"
                                ...
                                style="width: 95%; max-width: 550px; border: 8px solid white; z-index: 2; position: relative;">
                                    ...
                                    <div class="col-lg-5 d-none d-lg-block">
                                        <div
                                            ...
                                            <div class="card border-0 shadow-sm p-4 position-relative expertise-card"
                                                ...
                                                <div
                                                    class="blue fw-bold mb-3 pb-2 border-bottom d-flex align-items-center fs-5">
        ...
        </section>        <!-- Our Classes Clickable Tiles Section -->
        ...
        <div class="ourClassContainer spag" style="display: none;">
            <div class="ourClassChild shadow-lg rounded p-0">
                <div class="popup-header bg-primary text-white p-4 position-relative">
                    ...
                    <h5 class="fw-semibold mb-3 fs-4">Available Modules:</h5>                    <div class="row g-3">
                        <div class="col-md-6">
        ...
        <div class="ourClassContainer creative-writing" style="display: none;">
            <div class="ourClassChild shadow-lg rounded p-0">
                <div class="popup-header bg-warning text-dark p-4 position-relative">
                    ...
                    <ul class="list-unstyled mb-3">                        <li class="mb-4 d-flex">
        ...
        <section class="testimonials-section py-5 position-relative overflow-hidden" style="background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 50%, #f8f9fa 100%);">
            ...
            <div class="container-fluid px-4 position-relative" style="max-width: 90vw; z-index: 2;">                <!-- Section Header -->
                <div class="text-center mb-5">
                                        ...
                                        <div class="testimonial-card h-100 card border-0 shadow-lg p-4 position-relative overflow-hidden" style="border-radius: 1rem; transition: all 0.3s ease;">
                                            ...
                                            <div class="position-relative" style="z-index: 2;">
                                                <div class="d-flex align-items-center mb-4">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-bold mb-1 text-success">Mrs L King</h6>                                                        <p class="text-dark mb-0">Birmingham</p>
                                                    </div>
                                                </div>                                                <blockquote class="mb-0">
                                        ...
                                        <div class="testimonial-card h-100 card border-0 shadow-lg p-4 position-relative overflow-hidden" style="border-radius: 1rem; transition: all 0.3s ease;">
                                            ...
                                            <div class="position-relative" style="z-index: 2;">
                                                <div class="d-flex align-items-center mb-4">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-bold mb-1 text-danger">Mr P Jain</h6>                                                        <p class="text-dark mb-0">Kent</p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="testimonial-card h-100 card border-0 shadow-lg p-4 position-relative overflow-hidden" style="border-radius: 1rem; transition: all 0.3s ease;">
                                            ...
                                            <div class="position-relative" style="z-index: 2;">
                                                <div class="d-flex align-items-center mb-4">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-bold mb-1" style="color: var(--theme-blue);">Mrs G Rajapaksha</h6>                                                        <p class="text-dark mb-0">East London</p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="testimonial-card h-100 card border-0 shadow-lg p-4 position-relative overflow-hidden" style="border-radius: 1rem; transition: all 0.3s ease;">
                                            ...
                                            <div class="position-relative" style="z-index: 2;">
                                                <div class="d-flex align-items-center mb-4">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-bold mb-1" style="color: #fd7e14;">Mrs S Aslan</h6>                                                        <p class="text-dark mb-0">Surrey</p>
                                                    </div>
                                                </div>
                                                <blockquote class="mb-3">
                                                    <p class="mb-0 lh-lg text-dark" style="font-size: 1.1rem; font-style: italic;">"It's clear that your dedication, expertise, and personalized teaching methods are making a huge difference. I'm so grateful for the positive influence you've had on her academic growth and language development."</p>                                                </blockquote>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="testimonial-card h-100 card border-0 shadow-lg p-4 position-relative overflow-hidden" style="border-radius: 1rem; transition: all 0.3s ease;">
                                            ...
                                            <div class="position-relative" style="z-index: 2;">
                                                <div class="d-flex align-items-center mb-4">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-bold mb-1 text-secondary">Mrs T James</h6>                                                        <p class="text-dark mb-0">Leeds</p>
                                                    </div>
                                                </div>                                                <blockquote class="mb-0">
                            ...
                            <div class="testimonial-card card border-0 shadow-lg p-4 position-relative overflow-hidden" style="border-radius: 1rem;">
                                ...
                                <div class="position-relative" style="z-index: 2;">
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <div>
                                            <h6 class="fw-bold mb-1" style="color: var(--theme-blue);">Mrs C Cheung</h6>                                            <p class="text-dark mb-0">Reading</p>
                                        </div>
                                    </div>                                    <blockquote class="mb-0">
                            ...
                            <div class="testimonial-card card border-0 shadow-lg p-4 position-relative overflow-hidden" style="border-radius: 1rem;">
                                ...
                                <div class="position-relative" style="z-index: 2;">
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <div>
                                            <h6 class="fw-bold mb-1" style="color: var(--theme-gold);">Mr J Aujla</h6>                                            <p class="text-dark mb-0">Harrow</p>
                                        </div>
                                    </div>                                    <blockquote class="mb-0">
        ...
        <!-- End Testimonials Section -->        <!-- Try a Class Section -->
        ...
        <section class="how-we-learn-section py-5">
            <div class="container-fluid px-4" style="max-width: 90vw;">
                ...
                <div class="row g-4 justify-content-center">
                    ...
                    </div>                    <!-- Benefits/Structure Section -->
