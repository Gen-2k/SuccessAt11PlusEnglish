...
// Assuming 'year4' is the identifier for this page/language
$languageOrPageId = 'year4'; 
// Or use session if available: $languageOrPageId = $_SESSION['classid'] ?? 'year4'; 
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="keywords" content="Year 4 Tuition, 11 Plus English, Primary School English, Online Tutoring UK, Comprehension, Creative Writing, SPaG, Vocabulary">
    <meta name="description" content="Expert online tuition for Year 4 students focusing on 11 Plus English preparation, Comprehension, Creative Writing, SPaG, Vocabulary, and Verbal Reasoning.">
    
    <!-- Open Graph Meta Tags -->
    <meta property="og:site_name" content="Success At 11 Plus English">
    <meta property="og:title" content="Year 4 Online English Tuition | Success At 11 Plus English">
    <meta property="og:url" content="<?php echo (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; ?>">
    <meta property="og:image" content="<?php echo rtrim(BASE_URL, '/'); ?>/assets/images/logonew.png">
    
    <title>Year 4 English Modules | Success At 11 Plus English</title>
...
<body>
    ...
    <div class="container section-padding">
        <header class="text-center mb-5">
            <div class="mb-3">
                <i class="bi bi-book display-4 violet"></i>
            </div>
            <h1 class="display-4 violet mb-3">Year 4 Modules</h1>
        ...
        <section class="mb-5 pb-4">
             <h2 class="section-heading violet">Year 4 Module Details</h2>            <div class="module-card" id="comprehension">
                <div class="row g-4 align-items-stretch">
                    ...
                    <div class="col-lg-7 module-content-col text-center text-lg-start">
                        <h3>COMPREHENSION</h3>
                        <p>Teaching skills and techniques to improve speed and accuracy of answering multiple choice and worded questions. Develop critical reading skills essential for 11 Plus success.</p>
                        <div class="module-buttons mt-auto pt-3">
                            <a href="<?php echo BASE_URL; ?>applyForm.php?class=year4&module=Comprehension" class="btn btn-apply"><i class="bi bi-check-circle-fill"></i>Apply Now</a>
                            <a href="<?php echo BASE_URL; ?>syllabus_juniorteensp" class="btn btn-syllabus"><i class="bi bi-book-fill"></i>Syllabus</a>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="row g-4 align-items-stretch">
                     ...
                     <div class="col-lg-7 module-content-col text-center text-lg-start">
                        ...
                        <div class="module-buttons mt-auto pt-3">
                              <a href="<?php echo BASE_URL; ?>applyForm.php?class=year4&module=Creative Writing" class="btn btn-apply"><i class="bi bi-check-circle-fill"></i>Apply Now</a>
            ...
            <div class="module-card" id="spag">
                 <div class="row g-4 align-items-stretch">
                    ...
                    <div class="col-lg-7 module-content-col text-center text-lg-start">
                        <h3>SPaG </h3>
                        <p>Spelling, Punctuation and Grammar - complete syllabus with guided tests and revision.</p>                        <div class="module-buttons mt-auto pt-3">                              <a href="<?php echo BASE_URL; ?>applyForm.php?class=year4&module=SPaG" class="btn btn-apply"><i class="bi bi-check-circle-fill"></i>Apply Now</a>
                  ...
                  <div class="row g-4 align-items-stretch">
                     ...
                     <div class="col-lg-7 module-content-col text-center text-lg-start">
                         ...
                         <div class="module-buttons mt-auto pt-3">
                               <a href="<?php echo BASE_URL; ?>applyForm.php?class=year4&module=English Vocabulary" class="btn btn-apply"><i class="bi bi-check-circle-fill"></i>Apply Now</a>
                             <a href="<?php echo BASE_URL; ?>syllabus_adultsp" class="btn btn-syllabus"><i class="bi bi-book-fill"></i>Syllabus</a>
                         </div>
                     </div>
            </div>
        </div>
            ...
            <div class="module-card" id="carousel-course">
                  <div class="row g-4 align-items-stretch">
                     ...
                     <div class="col-lg-7 module-content-col text-center text-lg-start">
                         ...
                         <div class="module-buttons mt-auto pt-3">
                               <a href="<?php echo BASE_URL; ?>applyForm.php?class=year4&module=Carousel Course" class="btn btn-apply"><i class="bi bi-check-circle-fill"></i>Apply Now</a>
            ...
            <div class="module-card" id="one-to-one">
                  <div class="row g-4 align-items-stretch">
                     ...
                     <div class="col-lg-7 module-content-col text-center text-lg-start">
                         ...
                         <div class="module-buttons mt-auto pt-3">
                               <a href="<?php echo BASE_URL; ?>applyForm.php?class=year4&module=1:1 Tutoring" class="btn btn-apply"><i class="bi bi-check-circle-fill"></i>Apply Now</a>
