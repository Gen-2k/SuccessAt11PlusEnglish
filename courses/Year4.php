        ...
        <section class="mb-5 pb-4">
             <h2 class="section-heading blue">Year 4 Module Details</h2>            <div class="module-card" id="comprehension">
                <div class="row g-4 align-items-stretch">
                    <div class="col-lg-5 module-image-col">
                        <img src="assets/images/success/img13.png" alt="Comprehension skills" />

                    </div> 
                    <div class="col-lg-7 module-content-col text-center text-lg-start">
                        <h3>COMPREHENSION</h3>
                        <p class="text-dark fs-5">Teaching skills and techniques to improve speed and accuracy of answering multiple choice and worded questions. Develop critical reading skills essential for 11 Plus success.</p>
            ...
            <div class="module-card" id="spag">
                 <div class="row g-4 align-items-stretch">
                    ...
                    <div class="col-lg-7 module-content-col text-center text-lg-start">
                        <h3>SPaG </h3>
                        <p class="text-dark fs-5">Spelling, Punctuation and Grammar - complete syllabus with guided tests and revision.</p>                        <div class="module-buttons mt-auto pt-3">                              <a href="<?php echo BASE_URL; ?>applyForm.php?class=year4&module=SPaG" class="btn btn-apply"><i class="bi bi-check-circle-fill"></i>Apply Now</a>
