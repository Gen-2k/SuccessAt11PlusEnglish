...
<body>
    ...
    <!-- Optional: Include Standard Navbar -->
    <!-- <?php // include rtrim(BASE_URL, '/') . '/navbar.php'; // Adjust path as needed ?> -->
        ...
        <section id="pricing" class="mb-5 pb-4 pricing-section">
            ...
            <div class="card shadow-lg mx-auto" style="max-width: 800px;">
                 <div class="card-body p-4 p-md-5">
                    <!-- All Modules/Options -->
                    <div class="mb-4"> <!-- Single container for all items -->
                        <h3 class="mb-4"><i class="bi bi-grid-1x2-fill me-2"></i>Modules & Tuition</h3> <!-- Updated heading -->
                        <p class="text-muted mb-3 small">Choose from dedicated modules or flexible tuition options.</p> <!-- Updated description -->
        ...
        <section class="mb-5 pb-4">
                ...
                <div class="row g-4 align-items-stretch"> <!-- Added g-4 for gutters -->
                    ...
                    <div class="col-lg-7 module-content-col text-center text-lg-start">
                        ...
                        <p>Teaching Skills / Techniques to improve speed and accuracy of answering multiple choice and worded questions.</p>                        <div class="module-buttons mt-auto pt-3">
                            <!-- Original Links Updated with Proper Parameters -->
                            ...
                            <a href="<?php echo BASE_URL ?>syllabus_juniorteensg" class="btn btn-syllabus"><i class="bi bi-book-fill"></i>Syllabus</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="module-card" id="spag">
                 <div class="row g-4 align-items-stretch">
                    ...
                    <div class="col-lg-7 module-content-col text-center text-lg-start">
                        <h3>SPaG</h3>
                        <p>Spelling, Punctuation and Grammar - complete syllabus with guided tests and revision.</p>                        <div class="module-buttons mt-auto pt-3">
                  ...
                  <div class="row g-4 align-items-stretch">
                     ...
                     <div class="col-lg-7 module-content-col text-center text-lg-start">
                         ...
                         <div class="module-buttons mt-auto pt-3">
                             ...
                             <a href="<?php echo BASE_URL; ?>syllabus_adultsg" class="btn btn-syllabus"><i class="bi bi-book-fill"></i>Syllabus</a>                         </div>
                     </div>
                 </div>
             </div>
