...
// Get answers resources for the student
$answers_resources = getStudentResources($student_id, 'answers');
?>
...
<main class="main-content">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="page-title">Answer Sheets</h1>
                    <p class="page-subtitle">Access your answer sheets and solutions</p>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb">
        ...
        <div class="container-fluid">
            <!-- Answer Sheet Resources -->
            <?php if (!empty($answers_resources)): ?>            <div class="resource-grid">
                <?php foreach ($answers_resources as $resource): ?>
                <div class="resource-card answers">
                    ...
                    <div class="resource-card-body">                        <?php if ($resource['description']): ?>
                        ...
                        <div class="resource-actions">
                            <?php if ($resource['file_path'] && resourceFileExists($resource['file_path'], 'answers')): ?>                            <a href="<?php echo htmlspecialchars(getResourceUrl($resource['file_path'], 'answers')); ?>" 
                               target="_blank" class="btn btn-answers">
                                <i class="fas fa-eye"></i> View Answers
                            </a>
                            <?php else: ?>
                            <button class="btn btn-outline" disabled>
                                <i class="fas fa-exclamation-triangle"></i> Answers Not Available
                            </button>
