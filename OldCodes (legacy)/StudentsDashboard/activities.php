...
$userid =  $_SESSION['id'];
// we changed line 12 'add concodinate'for testing
...
<body>
    ...
    <div class="container pt-3">
        <h1 class="fw-bold text-center text-white">ACTIVITIES</h1>
        ...
        <div class="d-flex flex-wrap justify-content-center card_main_Container">
            <div class="sudent_card shadow-lg p-3 mb-3  rounded mar"
                ...
                ?>
                <a href="itemsactivity?actterm=<?php echo 'Term 1' ?>" class="text-decoration-none">
                    <?php
                    }
                }
                    ?>
            ...
            <div class="sudent_card shadow-lg p-3 mb-3  rounded mar"
                ...
                ?>
                <a href="itemsactivity?actterm=<?php echo 'Term 2' ?>" class="text-decoration-none">
                    <?php
                    }
                }
                    ?>
            ...
            <div class="sudent_card shadow-lg p-3 mb-3  rounded mar"
                ...
                ?>
                <a href="itemsactivity?actterm=<?php echo 'Term 3' ?>" class="text-decoration-none">
                    <?php
                    }
                }
                    ?>
            ...
            <div class="sudent_card shadow-lg p-3 mb-3  rounded mar"
                ...
                ?>
                <a href="itemsactivity?actterm=<?php echo 'Term 4' ?>" class="text-decoration-none">
                    <?php
                    }
                }
                    ?>
            ...
            <div class="sudent_card shadow-lg p-3 mb-3  rounded mar"
                ...
                ?>
                <a href="itemsactivity?actterm=<?php echo 'Term 5' ?>" class="text-decoration-none">
                    <?php
                    }
                }
                    ?>
            ...
            <div class="sudent_card shadow-lg p-3 mb-3  rounded mar"
                ...
                ?>
                <a href="itemsactivity?actterm=<?php echo 'Term 6' ?>" class="text-decoration-none">
                    <?php
                    }
                }
                    ?>
            ...
            <div class="sudent_card shadow-lg p-3 mb-3  rounded mar"
                ...
                ?>
                <a href="itemsactivity?actterm=<?php echo 'Term 7' ?>" class="text-decoration-none">
                    <?php
                    }
                }
                    ?>
            ...
            <div class="sudent_card shadow-lg p-3 mb-3  rounded mar"
                ...
                ?>
                <a href="itemsactivity?actterm=<?php echo 'Term 8' ?>" class="text-decoration-none">
                    <?php
                    }
                }
                    ?>
            ...
            <div class="sudent_card shadow-lg p-3 mb-3  rounded mar"
                ...
                ?>
                <a href="itemsactivity?actterm=<?php echo 'Term 9' ?>" class="text-decoration-none">
                    <?php
                    }
                }
                    ?>
            ...
            <div class="sudent_card shadow-lg p-3 mb-3  rounded mar"
                ...
                ?>
                <a href="itemsactivity?actterm=<?php echo 'Term 10' ?>" class="text-decoration-none">
                    <?php
                    }
                }
                    ?>
            ...
            <div class="sudent_card shadow-lg p-3 mb-3  rounded mar"
                ...
                ?>
                <a href="itemsactivity?actterm=<?php echo 'Term 11' ?>" class="text-decoration-none">
                    <?php
                    }
                }
                    ?>
            ...
            <div class="sudent_card shadow-lg p-3 mb-3  rounded mar"
                ...
                ?>
                <a href="itemsactivity?actterm=<?php echo 'Term 12' ?>" class="text-decoration-none">
                    <?php
                    }
                }
                    ?>
            ...
            <div class="sudent_card shadow-lg p-3 mb-3  rounded mar"
                ...
                ?>
                <a href="itemsactivity?actterm=<?php echo 'Term 13' ?>" class="text-decoration-none">
                    <?php
                    }
                }
                    ?>
