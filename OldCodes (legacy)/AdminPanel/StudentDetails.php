    ...
    <div class="body_container">
        ...
        <div class="container">
            ...
            <div id="cat_btn" class="my-2">
                <input type="radio" name="stucategorytSelect" value="SpaG" class="stucatRadio filt"
                    id="pre-prep-cul">
                <label for="pre-prep-cul" class="subjectBtn my-2 fw-bold user-select-none me-1">SpaG</label>
                <input type="radio" name="stucategorytSelect" value="Creative writing" class="stucatRadio filt" id="junior-cul">
                <label for="junior-cul" class="subjectBtn my-2 fw-bold user-select-none me-1">Creative writing</label>
                <input type="radio" name="stucategorytSelect" value="Comprehension" class="stucatRadio filt" id="Early-Teen-cul">
                <label for="Early-Teen-cul" class="subjectBtn my-2 fw-bold user-select-none me-1">Comprehension</label>
                <input type="radio" name="stucategorytSelect" value="Vocabulary" class="stucatRadio filt" id="adults-cul">
